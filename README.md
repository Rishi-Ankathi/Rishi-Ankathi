...
Behavioral authentication that tells users apart from their typing patterns alone, using a neural network trained on keystroke dynamics.

Full pipeline — preprocessing, feature scaling, sequence generation, training, evaluation — reaching **83.21% test accuracy**, with a Streamlit dashboard for training curves and confusion matrices.
